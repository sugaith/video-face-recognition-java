...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.3\textwidth]{ilustracao_tcc_sistema}
...
\codigoPython
\lstinputlisting[language=Java, label=coleta-script, caption=\textit{Script} coletar-hashtags.py]{src/c.java}
